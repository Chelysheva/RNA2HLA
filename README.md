...
4c) Packages: [biopython](https://github.com/biopython/biopython) (developed with 1.76), [numpy](https://github.com/numpy/numpy) (developed with 1.16.6, **!caused an error for one user, therefore - 1.15 is preferable)**, [pandas](https://github.com/pandas-dev/pandas) (developed with 0.24.2)
