...
# -*- coding: utf-8 -*-
"""
Ported to Python 3 on Wed Jul 29 2026
Originally updated on Sat Nov 14 2020
...
#
#Usage:
#python3 RNA2HLA.py -f /folder_with_raw_RNAseq_data [-r /global_name_of_run]* [-p <int>]** [-3 <int>]*** [-c <float>]**** [-g <int]*****
...
#
#Dependencies:
#1) RNA2HLA is a python script (python 3).
...
#6) Packages: biopython, numpy, pandas.
#
#Output:
...
if __name__ == '__main__':
    ...
    #directory this very script lives in, so paired_end.py/single_end.py are found
            ...
            if pair:
                ...
                if readFile2:
                    ...
                    if globalrunName:
                        ...
                        runName = samplename
                    subprocess.run([sys.executable, os.path.join(script_dir, "paired_end.py"),
                                     "-1", readFile1, "-2", readFile2, "-f", readFolder,
                                     "-r", runName, "-p", threads, "-3", trim3, "-g", genes])
                if not readFile2:
                ...
                if not pair2:
                    ...
                    if globalrunName:
                        ...
                        runName = samplename
                    subprocess.run([sys.executable, os.path.join(script_dir, "single_end.py"),
                                     "-1", readFile1, "-f", readFolder,
                                     "-r", runName, "-p", threads, "-3", trim3, "-g", genes])
